...
onMounted(() => {
  axios.get('https://sql107.infinityfree.com/GRP5_MIDNIGHTS/backend/reviewsapi.php?action=get_all')
    .then((response) => {
...
<template>
  <main>
    ...
    <div class="reviews-button-content">
      <RouterLink to="/createreview" class="button">Leave a Review</RouterLink>
    </div>
    ...
    <div class="review-container">
      <ReviewBox v-for="(review, index) in reviews.slice(3, 6)" :key="index" :review="review" />
    </div>

    <div class="review-container">
      <ReviewBox v-for="(review, index) in reviews.slice(6, 9)" :key="index" :review="review" />
    </div>

    <div class="review-container">
      <ReviewBox v-for="(review, index) in reviews.slice(9, 12)" :key="index" :review="review" />
    </div>
    <Footers />
  </main>
