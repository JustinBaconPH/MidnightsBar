...
const bookings = [
  { name: 'John Doe', review: 'wow'},
  { name: 'Jane Smith', review: 'wowow'},
  { name: 'John Doe', review: 'wowwwow'},
  { name: 'Jane Smith', review: 'wowwow'},
  { name: 'John Doe', review: 'wowoww'},
  { name: 'Jane Smith', review: 'wowwow'},
  { name: 'John Doe', review: 'wowwwwow'},
  { name: 'Jane Smith', review: 'wwwwowow'},
