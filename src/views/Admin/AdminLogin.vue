...
left: 90px; /* Adjust the left position according to your preference */
}
...
background-color: #3490dc; /* Set a background color for the button */
color: #ffffff; /* Set text color for the button */
border: none;
}

.login-form a {
color: #3490dc; /* Set color for links */
}
