...
<nav>
    ...
    <div class="menu-container">
        <ul>
            <li><RouterLink to="/home" class="nav-link" active-class="active">HOME</RouterLink></li>
            <li><RouterLink to="/about" class="nav-link" active-class="active">ABOUT US</RouterLink></li>
            <li><RouterLink to="/gallery" class="nav-link" active-class="active">GALLERY</RouterLink></li>
            <li><RouterLink to="/packages" class="nav-link" active-class="active">PACKAGES</RouterLink></li>
            <li><RouterLink to="/reviews"  class="nav-link" active-class="active">REVIEWS</RouterLink></li>
            <li><RouterLink to="/contactus"  class="nav-link" active-class="active">CONTACT US</RouterLink></li>
            <li><RouterLink to="/booking"  class="nav-link" active-class="active">BOOK</RouterLink></li>
        </ul>
    </div>
    <div class="blank-container"></div>
